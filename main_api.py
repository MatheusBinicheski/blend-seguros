...
async def _executar_fase1(job_id: str, dados: dict):
    ...
    # Sondagem de preço desligada — cada seguradora exige um fluxo específico de UI
    # que precisa ser depurado individualmente (ver screenshots em /tmp/{seg}_sondagem.png).
    # Os arquivos sondar_preco_morte() em cada módulo permanecem como ponto de partida.
